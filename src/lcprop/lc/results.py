"""Canonical liquid-crystal workflow result types."""

from dataclasses import dataclass, field
from typing import Any

from lcprop.lc.requests import SweepMemberStatus
...
class StaticRunResult:
    """Result returned by the LC static workflow."""
...
class TimeDependentRunResult:
    """Result returned by the LC time-dependent workflow."""
